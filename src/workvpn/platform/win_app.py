...
from PySide6.QtGui import QDesktopServices, QColor, QFont, QIcon, QKeySequence, QPixmap, QRegion, QShortcut
...
from .win_backend import (
    ...
    create_tray_image,
    fetch_public_ip,
    get_windows_system_icon_file,
    is_admin,
    pystray,
    relaunch_as_admin,
    resource_path,
    set_windows_app_id,
    singbox_creationflags,
    singbox_startupinfo,
...
class WorkVpnWindow(QMainWindow):
    def __init__(self):
        ...
        self.setWindowIcon(QIcon(str(get_windows_system_icon_file())))
        self.setWindowFlag(Qt.WindowType.WindowMaximizeButtonHint, False)
    ...
    def update_responsive_sizes(self):
        ...
        for button in (self.token_btn, self.log_btn, self.exit_btn):
            ...
            button.setFont(QFont("Segoe UI", max(14, min(17, round(w * 0.03))), QFont.Weight.Bold))
...
def main():
    ...
    app.setWindowIcon(QIcon(str(get_windows_system_icon_file())))
