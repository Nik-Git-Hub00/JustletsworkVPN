...
if (Test-Path $Iscc) {
    & $Iscc "installer\WorkVPN.iss" "/DAppVersion=$Version" "/DAppArch=arm64" "/DSourceExe=dist\WorkVPN.exe" "/DAppArchMode=arm64" "/DOutputDir=release" "/DOutputBaseFilename=WorkVPN-Setup-$Version-windows-arm64"
